...
public class a048_Methods {
    public static void main(String[] args) {
        ...
        int bonus = 100;
        // można deklarować zmienne, a w metodzie podawać ich nazwy
        int highScore = calculatedScore(gameOver, score, levelCompleted, bonus);
        System.out.println("Your final score was " + highScore);
        // można też hardcodować wartości w metodzie
        ...
        displayHighScorePosition("Monica", position);
    }
