...
//        System.out.println(list);
    ...
    public static void printItinearary(LinkedList<String> list) {
    ...
    public static void printItinearary2(LinkedList<String> list) {
        System.out.println("Trip starts at " + list.getFirst());
    ...
    public static void printItinearary3(LinkedList<String> list) {
        System.out.println("Trip starts at " + list.getFirst());
        String previousTown = list.getFirst();
